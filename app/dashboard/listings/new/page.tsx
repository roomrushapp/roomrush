            ...
            <div className="bg-zinc-900 border border-zinc-700 rounded-lg px-5 py-5">
              <div className="flex items-start justify-between gap-4 flex-wrap">
                ...
                <a
                  ...
                  className="flex-shrink-0 flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-4 py-2.5 font-medium text-sm transition-colors whitespace-nowrap rounded"
                >
