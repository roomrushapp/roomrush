...
export default function ShareButtons({ listing_id }: Props) {
  ...
  const shareFacebook = () => {
    window.open(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(getUrl())}`, "_blank", "noopener,noreferrer");
    trackEvent(listing_id, "share_facebook");
  };

  return (
    <div className="border-t border-zinc-200 pt-3 mt-1">
      <p className="text-xs text-zinc-400 uppercase tracking-wide mb-2">Share this listing</p>
