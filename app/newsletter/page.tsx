    ...
    <div className="bg-zinc-950 text-white min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        <div className="grid sm:grid-cols-2 gap-5 items-start">
          ...
          <div id="priority-alerts" className="group border border-zinc-700 bg-zinc-900 p-6 flex flex-col transition-all duration-200 hover:border-amber-500/50 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-amber-900/20 active:scale-[0.99] active:border-amber-500/50" style={{ borderTopColor: "rgb(217 119 6 / 0.5)", borderTopWidth: "2px", scrollMarginTop: "96px" }}>
            <div className="flex items-center justify-between mb-4">
