    ...
    <div className="flex flex-col gap-3">
      ...
      {contact_email && (
        <button
          ...
          className="flex items-center justify-center gap-2 bg-rose-600 hover:bg-rose-700 text-white px-4 py-3 font-medium text-sm transition-all active:scale-[0.97] w-full"
        >
          <Mail size={16} />
          Contact via email
        </button>
      ...
      {phone && (
        <>
          <button
            ...
            className="flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white px-4 py-3 font-medium text-sm transition-all active:scale-[0.97] w-full"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 border border-zinc-300 hover:border-zinc-500 text-zinc-700 px-4 py-3 font-medium text-sm transition-all active:scale-[0.97] w-full"
          >
            <Phone size={16} />
            {phone}
          </button>
      ...
      {normalizedFacebookUrl && (
        <a
          ...
          className="flex items-center justify-center gap-2 bg-[#1877F2] hover:bg-[#1464d8] text-white px-4 py-3 font-medium text-sm transition-all active:scale-[0.97] w-full"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
