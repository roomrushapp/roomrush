...
export default function NewListingPage() {
  ...
  async function uploadImages(listingId: string): Promise<string[]> {
    ...
    for (const file of imageFiles) {
      const processed = await compressListingImage(file);
      ...
      <div className="grid md:grid-cols-3 gap-10">
        ...
        <div className="md:col-span-2">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="bg-zinc-900 border border-zinc-700 rounded-lg px-5 py-5">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div className="min-w-0">
                  <p className="text-xs font-semibold text-rose-400 uppercase tracking-widest mb-1">Optional boost</p>
                  <h2 className="text-white font-semibold text-base leading-snug mb-2">Featured Listing early access</h2>
                  <p className="text-zinc-300 text-sm leading-relaxed mb-3">
                    RoomRush is now reaching 1,400+ monthly visitors. Want your listing to get seen earlier?
                    We'll place your listing near the top of RoomRush for 5 days and include it in our next newsletter.
                  </p>
                  <p className="text-white text-sm font-medium">
                    €5 to feature your listing for 5 days
                  </p>
                </div>
                <a
                  ...
                  className="flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white px-4 py-2.5 font-medium text-sm transition-colors rounded w-full sm:w-auto sm:flex-shrink-0 sm:whitespace-nowrap"
                >
