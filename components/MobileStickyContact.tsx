...
export default function MobileStickyContact({ listing_id, contact_email, phone, rent }: Props) {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-zinc-200 px-4 pt-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))] flex items-center gap-3 shadow-[0_-2px_12px_rgba(0,0,0,0.08)]">
      {/* Rent label */}
