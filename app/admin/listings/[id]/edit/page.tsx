...
export default function AdminEditListingPage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      setIsPartner(!!data.is_partner_listing);
      setForm({
        title: data.title ?? "",
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
      ...
      <h1 className="font-display font-bold text-2xl text-black mb-1">Edit Listing</h1>
      <p className="text-xs text-zinc-400 mb-6 font-mono">{id}</p>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <div className="border border-zinc-200 bg-zinc-50 p-4">
          ...
          <p className="text-xs text-zinc-400 mb-3">
            Shows a subtle attribution block on the listing detail page.
            Uncheck to remove it immediately.
          </p>
